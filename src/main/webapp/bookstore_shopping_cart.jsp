...
<div class="car">
    ...
    <div class="goods2">
        <table>
            ...
            <td width=700>
            <div>
                <img src="images/cart.png" width="50" height="50"><img width="25">Milky Way's bookstore -> Shopping Cart
            </div>
            </td>
    ...
    <div class="goods1">
        <table>
            <tr>
                <td width="700"></td>
                <td width="200"><button class="btn2">确认购买</button></td>
                <td width="200"><button class="btn3">全部清空</button></td>
            </tr>
        </table>
    </div>
